            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <article className="island-shell feature-card rounded-2xl p-4 sm:p-6">
                ...
                <p className="mt-4 text-xs text-[var(--sea-ink-soft)]">
                  Scadenza: <span className="font-semibold">{user.expiry_date ? new Date(user.expiry_date).toLocaleDateString('it-IT') : 'Non impostata'}</span>
                </p>
              </article>
